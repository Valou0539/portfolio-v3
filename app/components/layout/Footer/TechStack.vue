<template>
  <i18n-t
    ...
    tag="p"
    scope="global"
    class="tech-stack text-secondary/75 hidden max-w-96 text-sm sm:block"
  >
    <template #figma>
      <a href="https://www.figma.com" target="_blank" rel="noopener">Figma</a>
    </template>
    <template #windsurf>
      <a href="https://windsurf.dev" target="_blank" rel="noopener">Windsurf</a>
    </template>
    <template #nuxt>
      <a href="https://nuxt.com" target="_blank" rel="noopener">NuxtJs</a>
    </template>
    <template #tailwind>
    ...
    <template #righteous>
      <a
        href="https://fonts.google.com/specimen/Righteous"
        target="_blank"
        rel="noopener"
        >Righteous</a
      >
